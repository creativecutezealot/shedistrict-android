...
import com.appentus.shedistrict.Utils.AutoFitTextureView;
...
public class SurfaceVideoFragment extends Fragment
    ...
    private static final String TAG = "SurfaceVideoFragment";
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                mTextureView.setAspectRatio(200, 400);
            } else {
                mTextureView.setAspectRatio(200, 400);
            }
            configureTransform(width, height);
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        /*mMediaRecorder.setMaxDuration(59000);
        mMediaRecorder.setOutputFile(mNextVideoAbsolutePath);
